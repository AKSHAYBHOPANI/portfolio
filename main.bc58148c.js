        ...
        (o.prototype.reveal = function (t, e, n, i) {
          ...
          for (var y = 0; y < u.length; y++)
            (g = u[y].getAttribute("data-sr-id")),
              ...
              c(f),
              d(f),
              (N.tools.isMobile() && !f.config.mobile) || !N.isSupported() ? (f.domEl.setAttribute("style", f.styles.inline), (f.disabled = !0)) : f.revealing || f.domEl.setAttribute("style", f.styles.inline + f.styles.transform.initial)
        ...
        function n(n) {
          ;(n && 3 === n.which) ||
            ...
            t(r).each(function () {
              ...
              o.hasClass("open") &&
                ((n && "click" == n.type && /input|textarea/i.test(n.target.tagName) && t.contains(o[0], n.target)) || (o.trigger((n = t.Event("hide.bs.dropdown", r))), n.isDefaultPrevented() || (i.attr("aria-expanded", "false"), o.removeClass("open").trigger(t.Event("hidden.bs.dropdown", r)))))
            }))
        }
        function i(e) {
          return this.each(function () {
    ...
    !(function (e, n) {
      ...
      function w(t, e) {
        for (var n, i, o = [], r = 0, s = t.length; r < s; r++)
          (i = t[r]), i.style && ((n = i.style.display), e ? ("none" === n && ((o[r] = Ft.get(i, "display") || null), o[r] || (i.style.display = "")), "" === i.style.display && zt(i) && (o[r] = x(i))) : "none" !== n && ((o[r] = "none"), Ft.set(i, "display", n)))
      ...
      function L(t, e, n, i) {
        ...
        if (d && ((o = E(e, t[0].ownerDocument, !1, t, i)), (r = o.firstChild), 1 === o.childNodes.length && (o = r), r || i)) {
          ...
          if (l) for (u = a[a.length - 1].ownerDocument, yt.map(a, j), f = 0; f < l; f++) (c = a[f]), Gt.test(c.type || "") && !Ft.access(c, "globalEval") && yt.contains(u, c) && (c.src ? yt._evalUrl && yt._evalUrl(c.src) : s(c.textContent.replace(ae, ""), u))
        }
        return t
      }
      function q(t, e, n) {
      ...
      function M(t, e, n, i, o) {
        ...
        for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2)
          "margin" === n && (s += yt.css(t, n + _t[r], !0, o)),
            i ? ("content" === n && (s -= yt.css(t, "padding" + _t[r], !0, o)), "margin" !== n && (s -= yt.css(t, "border" + _t[r] + "Width", !0, o))) : ((s += yt.css(t, "padding" + _t[r], !0, o)), "padding" !== n && (s += yt.css(t, "border" + _t[r] + "Width", !0, o)))
        return s
      }
      function B(t, e, n) {
        var i,
                        ...
                        c = function () {
                          ...
                          if (!(t < s)) {
                            ...
                            ;(c = n && ("object" == typeof n || "function" == typeof n) && n.then),
                              yt.isFunction(c) ? (o ? c.call(n, r(s, e, d, o), r(s, e, p, o)) : (s++, c.call(n, r(s, e, d, o), r(s, e, p, o), r(s, e, d, e.notifyWith)))) : (i !== d && ((a = void 0), (l = [n])), (o || e.resolveWith)(a, l))
                          }
                        },
                        u = o
                          ? c
        ...
        style: function (t, e, n, i) {
          if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
            ...
            ;(r = typeof n),
              ...
              null != n && n === n && ("number" === r && (n += (o && o[3]) || (yt.cssNumber[a] ? "" : "px")), vt.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (c[e] = "inherit"), (s && "set" in s && void 0 === (n = s.set(t, n, i))) || (l ? c.setProperty(e, n) : (c[e] = n)))
          }
        },
            ...
            if (3 !== r && 8 !== r && 2 !== r)
              return void 0 === t.getAttribute
                ...
                : ((1 === r && yt.isXMLDoc(t)) || (o = yt.attrHooks[e.toLowerCase()] || (yt.expr.match.bool.test(e) ? we : void 0)),
                  void 0 !== n ? (null === n ? void yt.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n)) : o && "get" in o && null !== (i = o.get(t, e)) ? i : ((i = yt.find.attr(t, e)), null == i ? void 0 : i))
          },
          attrHooks: {
            type: {
              set: function (t, e) {
        ...
        trigger: function (t, e, i, o) {
          ...
          if (
            ...
            for (r = 0; (s = d[r++]) && !t.isPropagationStopped(); )
              (t.type = r > 1 ? l : f.bindType || p), (u = (Ft.get(s, "events") || {})[t.type] && Ft.get(s, "handle")), u && u.apply(s, e), (u = c && s[c]) && u.apply && Pt(s) && ((t.result = u.apply(s, e)), !1 === t.result && t.preventDefault())
            return (
          ...
          ajax: function (t, e) {
            ...
            ;(f = yt.event && h.global),
              ...
              h.hasContent
                ...
                : ((p = h.url.slice(r.length)), h.data && ((r += (De.test(r) ? "&" : "?") + h.data), delete h.data), !1 === h.cache && ((r = r.replace(Re, "$1")), (p = (De.test(r) ? "&" : "?") + "_=" + Ne++ + p)), (h.url = r + p)),
          ...
          position: function () {
            if (this[0]) {
              var t,
                ...
                i = { top: 0, left: 0 }
              return (
                "fixed" === yt.css(n, "position") ? (e = n.getBoundingClientRect()) : ((t = this.offsetParent()), (e = this.offset()), l(t[0], "html") || (i = t.offset()), (i = { top: i.top + yt.css(t[0], "borderTopWidth", !0), left: i.left + yt.css(t[0], "borderLeftWidth", !0) })),
  ...
  oOvE: function (t, e, n) {
    ;(function (t) {
      ;+(function (t) {
        ...
        ;(n.VERSION = "3.3.7"),
          (n.DEFAULTS = t.extend({}, t.fn.tooltip.Constructor.DEFAULTS, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>' })),
